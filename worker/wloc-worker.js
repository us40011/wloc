...
    <!-- 使用 GitHub Raw 绝对直链，并加入了防断网的自动降级兜底 -->
...
    <div id="fallbackLogo" style="display:none; width:72px; height:72px; border-radius:16px; margin:0 auto 10px auto; background:linear-gradient(135deg, #007aff, #5856d6); box-shadow:0 4px 16px rgba(0, 122, 255, 0.25); align-items:center; justify-content:center;">
...
    <a class="btn btn-tg" href="https://t.me/+ySKmeLUxaAM5NGFk" target="_blank">💬 加入 Telegram 交流群</a>
  </div>
